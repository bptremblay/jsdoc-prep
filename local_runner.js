  ...
  function runJsDoc(sourceDirectory) {
    ...
    rimraf(
      ...
      function () {
        ...
        if (USE_HARUKI) {
          cmdLine += ' -r -l -t templates/../../tasks/experimental_template/haruki -d ' + reportPath + '/jsDocModel.json' + ' -q format=json' + ' ' + sourceDirectory + '';
          ...
          cmdLine += ' -r -l -t templates/../../tasks/experimental_template/default -d ' + docPath + '' + ' -q format=json' + ' ' + sourceDirectory + '';
        }
        console.log(cmdLine);
...
var processingChain = [
  ...
  'jsDoccerProc',
  'getES6ModuleDataProc',
  'esLintFixProc',
  // fixES6ModulesProc gathers ES6-specific metadata
