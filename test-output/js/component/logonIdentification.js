define(
  /**
   * @exports js/component/logonIdentification
   */
  function(require) {
    ...
    return {
      ...
      /**
       * Request identification advisory message.
       */
      ...
      /**
       * Request new identification code.
       */
      ...
      /**
       * Request identification code by call.
       */
       ...
       * @return object with arrays for each type (lower case)
       */
       ...
       * @return component name string. defaults to 'other' delivery type if not specified or not valid.
       */
      ...
      /**
       * Check for existing identification code.
       */
      ...
      /**
       * Handle no valid identification code.
       */
