 ...
 * @requires backbone
 * @requires immutable
 * @requires image-editor-basic-path/constants
 * @requires image-editor-basic-path/lib/image-helpers
 * @requires galileo-lib/modules/services/url-validator-service
 * @requires galileo-lib/modules/services/usage-tracking
 * @requires galileo-lib/modules/services/customer-service
 * @requires galileo-lib/modules/services/placeholder-service
 */
import $ from 'jquery';
import _ from 'underscore';
import Backbone from 'backbone';
import Immutable from 'immutable';
import constants from 'image-editor-basic-path/constants';
import imageHelpers from 'image-editor-basic-path/lib/image-helpers';
...
import customerService from 'galileo-lib/modules/services/customer-service';
import placeholderService from 'galileo-lib/modules/services/placeholder-service';
...
class StateModel extends Backbone.Model {
  ...
  _setMagnification() {
      return this.set({
        magnification: imageHelpers.fitMagnification(
