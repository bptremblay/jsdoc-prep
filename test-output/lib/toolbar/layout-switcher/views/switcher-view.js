...
define(['backbone', 'toolbar/layout-switcher/views/layout-view'],
  ...
  function (Backbone, LayoutView) {
    let SwitcherView;
    return SwitcherView = ( /**@lends module:lib/toolbar/layout-switcher/views/switcher-view~SwitcherView# */ function (superClass) {
      ...
      SwitcherView.prototype._findLayout = function (thumbnail) {
        return this.collection.find(layout => layout.attributes.layoutThumbnail === thumbnail);
      };
      /**
       * @private
       * @private 
