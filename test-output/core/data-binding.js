      ...
      return function () {
        for (var index = 0; index < map.length; index++) {
          ...
          if (textTransform != null) {
            if (typeof value === 'string' || (typeof value === 'object' && value.length != null)) {
          ...
          for (var pathWalker = 0; pathWalker < fieldPath.length; pathWalker++) {
            ...
            if (pathChunk === 'el' && (targetComponentField[pathChunk] == null)) {
          ...
          if (redrawOnUpdate) {
            if (targetComponentField[fieldName] != null) {
              ...
              Logger.warn("Could not set value of '" + componentId + '.' + fieldName + "' to " + value);
            }
          } else {
