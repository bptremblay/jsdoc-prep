define(
   ...
   * @requires ./is
   * @requires ./has
   * @requires ./nodeDictionary
   * @requires ./context/root
   * @requires ./log
   * @requires ./object/extend
   * @requires mout/object/merge
   * @requires mout/object/reject
   * @requires ./template/decorator
   * @requires ./declare
   * @requires template/helper
   * @requires blue/with/domEvents
   * @requires blue/with/stateAPI
   * @requires mout/array/slice
   * @requires blue/reactiveBridge
   * @requires blue/reactiveBridge
   * @requires ./with/domManagement
   * @requires ./with/domEvents
   * @requires ./with/locationAPI
   * @requires ./with/stateAPI
   */
  function (require) {
    var $ = require('./$'),
     ...
     * @constructor
     */
    var ReactiveView = require('./declare')( /** @lends module:blue/reactiveView~ReactiveView */ function () {
      ...
      function defineProperties(config) {
        ...
        Object.keys(config).forEach(function defineProperty(name) {
          ...
          this['_' + name] = function GetSet() {
            return !arguments.length ? config[name].get.call(this) : config[name].set.apply(this, arguments);
          }
        }.bind(this));
      };
      /**
      ...
      /** @alias module:blue/reactiveView~ReactiveView.prototype */
      var viewPrototype = {
        /**
