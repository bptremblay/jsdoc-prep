...
define(['jquery', 'backbone', 'template-engine', 'column-and-block-layout-editor-path/constants', 'column-and-block-layout-editor-path/padding/calculator', 'column-and-block-layout-editor-path/padding/renderer', 'column-and-block-layout-editor-path/padding/parser'], function($, Backbone, Mustache, constants, PaddingCalculator, PaddingRenderer, PaddingParser) {
  var ContentView, SELECTORS;
  SELECTORS = {
    editor: '[data-editor-type]'
  };
  return ContentView = (function(superClass) {
