...
const jsEscape = text.jsEscape;
const createXhr = text.createXhr;
const parseName = text.parseName;
const xdRegExp = text.xdRegExp;
const useXhr = text.useXhr;
const finishLoad = text.finishLoad;
const load = text.load;
const write = text.write;
const writeFile = text.writeFile;
const get = text.get;
export {
  version,
  strip,
