...
var autoDocTemplate = {
  "templates": {
    "template": [{
      ...
      "template": {
        "-kind": "3",
        "-name": "Type.Factory.Method.create",
        "-default": "false",
        "-signature": "false",
        "regex": "create(.+)",
      ...
      "template": [{
        "-kind": "3",
        "-name": "Type.Listener.Method.created",
        "-default": "false",
        "-signature": "false",
        "regex": "(.*)Created",
        "example": "autodocCreated",
        "text": "/**\n * Invoked when ${e.g(1).rs()} is created.\n */"
      }, {
        "-kind": "3",
        "-name": "Type.Listener.Method.updated",
        "-default": "false",
        "-signature": "false",
        "regex": "(.*)Updated",
        "example": "autodocUpdated",
      ...
      "-signature": "false",
      "regex": "f([A-Z].+)",
      "example": "fExampleMember",
      "text": "/**\n * The ${e.g(1).rsfl()}.\n */"
    }, {
      "-kind": "2",
      "-name": "Field.thePrefix",
      "-default": "false",
      "-signature": "false",
      "regex": "the[A-Z].+",
      "example": "theNumberOfQuestions",
      "text": "/**\n * ${e.rsfu()}.\n */"
    }, {
      "-kind": "2",
      "-name": "Field.Default",
      ...
      "-signature": "true",
      "regex": "\\S+ get(\\S+)\\(.*\\)",
      "example": "int getNumberOfQuestions()",
      ...
      "-kind": "3",
      "-name": "Method.boolean Getter",
      "-default": "false",
      "-signature": "true",
      "regex": "boolean is(.+)\\(.*\\)",
      "example": "boolean isBlue()",
      "text": "/**\n * Checks if is ${e.g(1).rsfl()}.\n * \n * @return true, if is ${e.g(1).rsfl()}\n */"
    }, {
      "-kind": "3",
      "-name": "Method.Main-Method",
      "-default": "false",
      "-signature": "true",
      "regex": "void main\\(String\\[\\] (\\S+)\\)",
      ...
      "-kind": "3",
      "-name": "Method.Returns boolean",
      "-default": "false",
      "-signature": "true",
      "regex": "boolean (\\S+)\\(.*\\)",
      "example": "boolean doSomething(int parameter)",
      "text": "/**\n * ${e.g(1).rsfu()}.\n * \n * @return true, if successful\n */"
    }, {
      "-kind": "3",
      "-name": "Method.Returns other",
      "-default": "false",
      "-signature": "true",
      "regex": "(\\S+) (\\S+)\\(.*\\)",
      "example": "ReturnValue calculateSomething()",
      "text": "/**\n * ${e.g(2).rsfu()}.\n * \n * @return the ${e.g(1).rsfl()}\n */"
    }, {
      "-kind": "3",
      "-name": "Method.Default",
      ...
      "-kind": "4",
      "-name": "Parameter.Generic Type Parameter",
      "-default": "false",
      "-signature": "false",
      "regex": "<(.+)>",
      "example": "<E>",
      ...
      "-signature": "false",
      "regex": ".+",
      "example": "simpleParameter",
      "text": "/**\n * @param ${e} the ${e.rsfl()}\n */"
    }, {
      "-kind": "5",
      "-name": "Exception.IOException",
      "-default": "false",
      "-signature": "false",
      "regex": "IOException",
      "example": "IOException",
  ...
  for (var index = 0; index < map.length; index++) {
    if (true) {
      ...
      if (obj.key) {
        ...
        var ownerClass = null;
        // TOOTSIE || obj.kind === 'constructor'
        if (obj.kind === 'method' || obj.kind === 'constructor') {
        ...
        // else {
        //    logger.log('@@@@@@@@@@@@@@@@@@@@@@@@ other kind >>>>', obj.kind);
        // }
        var key = obj.key;
      ...
      if (functionWrapper.name && functionWrapper.name !== '') {
        ...
        if (ownerClass) {
          logger.log('>>>>>>>>>>>>>>>>>>>>>>>>> ', ownerClass + '.' + functionWrapper.name);
          functionWrapper.memberOf = ownerClass;
        } else {
          logger.log('>>>>>>>>>>>>>>>>>>>>>>>>> ', '???.' + functionWrapper.name);
        }
  ...
  if (offset !== -1) {
    ...
    for (var index = 1; index < allSplits.length; index++) {
      ...
      if (ngChunkSplit.indexOf('(') === -1) {
        ...
        var classObj = addClass(walkerObj, capitalize(ngChunkSplit));
        classObj.extends = ngBaseClass;
      } else {
        input = originalInput;
...
function addModule(walkerObj, name) {
  if (!walkerObj.modules) {
    walkerObj.modules = {};
  }
  if (!walkerObj.modules[name]) {
    walkerObj.modules[name] = {
      shortName: '',
      longName: '',
      members: {},
      requires: [],
  ...
  return walkerObj.modules[name];
}
/**
 * Add a class to the classes we export.
 * @param   {object}   walkerObj [[Description]]
 * @param   {String} name      [[Description]]
 * @returns {object} the entry
 */
function addClass(walkerObj, name) {
  if (!walkerObj.classes) {
    walkerObj.classes = {};
  }
  if (!walkerObj.className) {
    walkerObj.className = name;
  }
  if (!walkerObj.classes[name]) {
    walkerObj.classes[name] = {
      methods: [],
      members: []
    };
  }
  return walkerObj.classes[name];
}

function addRequires(walkerObj, path, asName) {
  if (!asName) {
    if (path.indexOf('/') !== -1) {
      asName = path.split('/').pop();
    }
  }
  if (!asName) {
    asName = path.trim();
  ...
  if (!asName) {
    asName = 'IMPORT_ERRROR';
  }
  if (!walkerObj.requiredModules) {
    walkerObj.requiredModules = {};
  }
  if (!walkerObj.requiredModules[asName]) {
    walkerObj.requiredModules[asName] = {
      path: path,
      name: asName
    };
  }
  return walkerObj.requiredModules[asName];
}
/**
 *
 * @param walkerObj
...
function addMissingComments(walkerObj, errors) {
  ...
  addModule(walkerObj, moduleName);
  if (walkerObj.NG) {
  ...
  for (var meth = 0; meth < methodArray.length; meth++) {
    ...
    if (realMethod.ctor) {
      addClass(walkerObj, realMethod.name);
    }
    realMethod.returnType = realMethod.returnType ? realMethod.returnType : 'void';
    wrappedMethods.push({
  ...
  var jsDoccerBlob = {
    'lines': lines.length,
    'requires': [],
    'className': walkerObj.className,
    'extends': walkerObj.extends,
    'packagePath': '',
    'directoryPath': dir,
    'uses_Y': false,
    'no_lib': true,
...
function generateComment(functionWrapper, ast, walkerObj, input, commentBodyOpt, statusCheck) {
  ...
  if (type === 'ClassDeclaration') {
    var classObj = addClass(walkerObj, functionWrapper.name);
    ...
    if (srcLine.indexOf('extends ') !== -1) {
      ...
      if (!extendsTags) {
        ...
        if (srcLine.indexOf('~') === -1) {
          logger.warn('@extends needs to reference full path of module:moduleName~class');
        }
        commentBlock.push(' * @extends ' + srcLine);
      }
      classObj.extends = srcLine;
    }
  ...
  if (functionWrapper.comment === -1 && commentBlock.join('\n').indexOf(functionWrapper.name) === -1) {
    ...
    // console.log(functionWrapper);
    var parsedName = decamelize(functionWrapper.name).split('_');
    var parseNameString = parsedName.join(' ');
    if (parsedName.length > 1) {
      var firstWord = parsedName[0];
      var secondWord = parsedName[1];
      if (firstWord === 'get') {
        firstWord = 'Returns the value of';
      } else if (firstWord === 'set') {
        firstWord = 'Sets the value of';
      } else if (firstWord === 'is') {
        firstWord = 'Returns if is the';
      } else if (firstWord === 'has') {
        firstWord = 'Returns if has the';
      } else {
        // is secondWord a noun?
        if (secondWord === 'in' || secondWord === 'from' || secondWord === 'to' || secondWord === 'for' || secondWord === 'by' || secondWord === 'with' || secondWord === 'via') {
          firstWord = capitalize(firstWord + 's');
        } else {
          firstWord = capitalize(firstWord + 's the');
        }
      }
      parsedName[0] = firstWord;
      parseNameString = parsedName.join(' ') + '.';
      //      if (functionWrapper.name === 'getChildren'){
      //        var uid = functionWrapper.uid;
      //        var node = getNodeByUid(uid);
      //        console.log(functionWrapper, JSON.stringify(node.body, null, 2));
      //        fromns();
      //      }
      if (commentBlock.length === 1) {
        commentBlock.push(' * ' + parseNameString);
      }
    }
    if (functionWrapper.returnType && functionWrapper.returnType !== '?' && functionWrapper.returnType !== 'void') {
      commentBlock.push(' * ' + '@return ' + functionWrapper.returnType);
    }
    if (functionWrapper.returnType && functionWrapper.returnType === '?') {
  ...
  if (commentBlock.length === 1) {
    ...
    // TOOTSIE
    // functionWrapper.ctor = functionWrapper.ctor ? functionWrapper.ctor : hasConstructor;
    commentBlock.push(' */');
    if (hasConstructor) {
